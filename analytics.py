...
def get_performance_vs_benchmark(tickers: list, weights: list, benchmark: str = "SPY", period: str = "1y") -> dict:
    """
...
def get_risk_metrics(tickers: list, weights: list, benchmark: str = "SPY", period: str = "1y") -> dict:
    """
    Calculate:
...
def get_correlation_matrix(tickers: list, period: str = "1y") -> dict:
    """
